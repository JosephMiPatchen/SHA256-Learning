def sha256_impl_1(message):
    ...
    message += b'\x80'
    message += b'\x00' * ((56 - (original_byte_length + 1) % 64) % 64)
    message += original_byte_length.to_bytes(8, byteorder='big')
...
hash_result = sha256_impl_1(message)
